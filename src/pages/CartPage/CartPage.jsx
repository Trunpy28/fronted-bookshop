            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        >
                          ...
                          >
                            <DeleteOutlined
                              ...
                              onClick={() =>
                                removeCartMutate(item?.product?._id)
                              }
                            />
                          </div>
                        </div>
              ...
              <WrapperRight>
                <div style={{ width: "100%" }}>
                  ...
                  >
                      ...
                      >
                        ...
                        >
                          <div style={{ marginBottom: "3px" }}>
                            ...
                            {voucherData.data.discountType === "percentage"
                              ? "Theo phần trăm"
                          ...
                          <div style={{ marginBottom: "3px" }}>
                            ...
                            {voucherData.data.discountType === "percentage"
                              ? `${voucherData.data.discountValue}%`
                              : `${convertPrice(
                                  voucherData.data.discountValue
                                )}`}
                          </div>
                    ...
                    {appliedVoucherCode && voucherData?.data && discountPrice === 0 && (
                      ...
                      >
                        ...
                        {voucherData?.data?.minOrderValue && (
                  ...
                  {discountPrice > 0 && (
                    <WrapperTotal>
                      <span style={{ fontSize: "16px", color: "#00a551" }}>
                        Giảm giá
                      </span>
                      <span
                        style={{
